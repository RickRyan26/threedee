<script>
  ...
  import { IcosahedronGeometry, MeshStandardMaterial, SphereGeometry, Vector3 } from 'three';
  import { handleKeys, movement, rbp, status, trackHeight } from './state';

  let rb; // RigidBody ref
